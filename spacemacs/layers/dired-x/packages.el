;;; packages.el --- dired-x layer packages file for Spacemacs.
;;
;; Copyright (c) 2012-2017 Sylvain Benner & Contributors
;;
;; Author: 李冰 <Vxider@Vxider-Mac-Pro.local>
...
;; added to `dired-x-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `dired-x/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `dired-x/pre-init-PACKAGE' and/or
;;   `dired-x/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst dired-x-packages
  '())
